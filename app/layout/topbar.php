        ...
        <div class="flex justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="?page-manage-apps">
                    <img src="https://skylinecheats.com/img/main.png" alt="Skyline Auth Icon"
            ...
            <div class="hidden md:block">
                <a href="https://keyauth.readme.io" target="_blank" type="button"
                    class="inline-flex text-white bg-[#0f0f17] hover:opacity-60 hover:text-purple-700 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 transition duration-200 pt-3"
