                                    ...
                                    <form class="space-y-6" method="POST">
                                        <div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <label for="username"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Username:</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                <input type="password" id="pass" name="pass"
                                                    ...
                                                    placeholder=" " autocomplete="on">
                                                <label for="pass"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Password:</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                <input type="email" id="email" name="email"
                                                    ...
                                                    placeholder=" ">
                                                <label for="email"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Email:</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4 pt-3">
                                                ...
                                                <label for="sub"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">User
                                                    Subscription</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4 pt-3">
                                                ...
                                                <label for="client2fa"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">2FA</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                <input type="text" id="hwid" name="hwid"
                                                    ...
                                                    placeholder=" ">
                                                <label for="hwid"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Additional
                                                    HWID:</label>
                                            </div>
        ...
        <div class="mb-4 p-4">
            ...
            <p class="text-xs text-gray-500">After someone registers for your app with a license, they will appear here.
                <a href="https://keyauth.readme.io/reference/users-1" target="_blank"
                    class="text-purple-600  hover:underline">Learn More</a>.
            </p>
            <br>
            <div class="p-4 flex flex-col">
                <div class="overflow-x-auto">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative max-w-sm">
                                                ...
                                                <input datepicker datepicker-autohide type="datetime-local"
                                                    name="expiry"
                                                    class="bg-[#0f0f17] border border-gray-700 text-white-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full pl-10 p-2.5 "
                                            ...
                                            <div id="drawer-right-example"
                                                class="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-[#0f0f17] border border-purple-700 w-80"
                                                ...
                                                <div class="w-full mb-4 border border-gray-200 rounded-lg bg-[#0f0f17]">
                                                    ...
                                                    <div class="flex items-center justify-between px-3 py-2 border-t">
                                                        <button type="button" data-copy-target="genpw"
                                                            class="copy-button inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-purple-700 rounded-lg focus:ring-4 focus:ring-purple-200 hover:bg-purple-800">
                                                            Copy
                                                        </button>
                                    ...
                                    <form class="space-y-6" method="POST">
                                        <div>
                                            <div class="relative mb-4">
                                                <input type="text" id="user" name="user"
                                                    ...
                                                    placeholder=" " autocomplete="on">
                                                <label for="user"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">User</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <label for="var"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Variable</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <textarea id="data" name="data" rows="4"
                                                    class="block p-2.5 w-full text-sm text-white-900 bg-[#0f0f17] rounded-lg border border-gray-700 focus:ring-purple-500 focus:border-purple-500"
                                        ...
                                        <div class="flex items-center mb-4">
                                            <input id="readOnly" name="readOnly" type="checkbox" value=""
                                                class="w-4 h-4 text-purple-600 bg-[#0f0f17] border-gray-300 rounded focus:ring-purple-500 focus:ring-2"
                                                checked>
                                            <label for="readOnly"
                                                class="ml-2 text-sm font-medium text-white-900">Readonly</label>
                                        </div>
                                        <button name="setvar"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Set
                                            User Var</button>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <form class="space-y-6" method="POST">
                                        <div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <label for="sub"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Subscription</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <label for="expiry"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">License
                                                    Expiry Unit</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                <input type="text" inputmode="numeric" id="time" name="time"
                                                    ...
                                                    placeholder=" " autocomplete="on">
                                                <label for="time"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Time
                                                    To Add</label>
                                            </div>
                                        </div>
                                        ...
                                        <button name="extenduser"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Extend
                                            User(s)</button>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" method="POST">
                                        ...
                                        <button name="subtractuser"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Subtract
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button name="importusersFile"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Import
                                            Users</button>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <form class="space-y-6" method="POST">
                                        <div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <label for="users"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Ban
                                                    Reason:</label>
                                            </div>
                                        </div>
                    ...
                    <p class="text-xs text-red-600">Dropdown actions in <b>RED</b> do not show a confirmation!<a
                            class="text-purple-700"> Dropdown actions in <b>purple</b> will show a confirmation!</a></p>
