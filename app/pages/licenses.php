                ...
                <form class="space-y-6" method="POST">
                    <div>
                        ...
                        <div class="relative mb-4">
                            ...
                            <label for="level"
                                class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Level:</label>
                        </div>
                        ...
                        <div class="relative mb-4">
                            <input type="text" id="duration" name="duration"
                                ...
                                placeholder=" ">
                            <label for="duration"
                                class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Duration:</label>
                        </div>
...
<div class="p-4 bg-[#09090d] block sm:flex items-center justify-between lg:mt-1.5">
    ...
    if (isset($_SESSION['keys_array'])) {
        ...
        echo "<button onclick=\"copyToClipboard()\" class=\"inline-flex text-white bg-purple-700 hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 transition duration-200\">Copy new licenses</button>";
    ...
    ?>
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" method="POST">
                                        ...
                                        <button type="submit" name="genkeys"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Generate
                                            Keys</button>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <form class="space-y-6" method="POST">
                                        <div>
                                            ...
                                            <div class="relative mb-4  ">
                                                ...
                                                <label for="expiry"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Unit
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg pt-5">
                        <table id="kt_datatable_licenses" class="w-full text-sm text-left text-white">
                            <thead>
                                <tr class="border-2 border-gray-200 text-purple-700 px-7">
