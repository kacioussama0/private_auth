...
<div class="p-4 bg-[#09090d] block sm:flex items-center justify-between lg:mt-1.5">
    <div class="mb-1 w-full bg-[#0f0f17] mt-4 md:mt-12 rounded-xl">
        <div class="mb-4 p-8">
            ...
            <p class="text-xs text-purple-500">This is where it all begins. <a
            ...
            <div class="flex flex-col">
                <div class="overflow-x-auto">
                    ...
                    <p class="text-base text-purple-300">Application Credentials</p>
                    <p class="text-xs text-purple-500">Simply replace the placeholder code in the
                        example with these</p>
                    <div class="mb-4 border-b border-purple-200">
                        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                            data-tabs-toggle="#myTabContent" role="tablist">
                            <li class="mr-2" role="presentation">
                                <button
                                    class="inline-block p-4 rounded-t-lg text-purple-400 hover:text-white transition duration-200"
                    ...
                    <div id="myTabContent">
                        <div class="p-4 rounded-lg bg-[#09090d]" id="csharp" role="tabpanel"
                            ...
                            <pre id="csharp-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
public static api KeyAuthApp = new api(
    ...
    version: "<?= $version; ?>"
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="cplusplus" role="tabpanel"
                            ...
                            <pre id="cpp-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
...
std::string url = skCrypt("https://auth.skylinecheats.com/api/1.2/").decrypt(); // change if you're self-hosting</pre>
                            <br>
                            <button type="button"
                                class="copy-button mt-3 inline-flex text-white bg-[#0f0f17] hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-200"
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="python" role="tabpanel"
                            ...
                            <pre id="py-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
keyauthapp = api(
    name = "<?= $appname; ?>",
    ownerid = "<?= $ownerid; ?>",
    secret = "<?= $secret; ?>",
    ...
    hash_to_check = getchecksum()
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="php" role="tabpanel" aria-labelledby="php-tab">
                            <pre id="php-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
$name = "<?= $appname; ?>";
$ownerid = "<?= $ownerid; ?>";</pre>
                            <br>
                            <button type="button"
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="js" role="tabpanel" aria-labelledby="js-tab">
                            <pre id="js-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
const KeyAuthApp = new KeyAuth(
    ...
    "<?= $version; ?>",
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="j" role="tabpanel" aria-labelledby="j-tab">
                            <pre id="j-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
...
private static String version = "<?= $version; ?>"</pre>
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="vb" role="tabpanel" aria-labelledby="vb-tab">
                            <pre id="vb-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
...
Private Shared version As String = "<?= $version; ?>"</pre>
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="rust" role="tabpanel" aria-labelledby="rust-tab">
                            <pre id="rust-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
let mut keyauthapp = keyauth::v1_2::KeyauthApi::new(
    ...
    "https://keyauth.win/api/1.2/", // This is the API URL, change this to your custom domain if you have it enabled
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="go" role="tabpanel" aria-labelledby="go-tab">
                            <pre id="go-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
var name = "<?= $appname; ?>"
var ownerid =  "<?= $ownerid; ?>"
var version = "<?= $version; ?>"</pre>
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="lua" role="tabpanel" aria-labelledby="lua-tab">
                            <pre id="lua-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
local name = "<?= $appname; ?>";
...
local version = "<?= $version; ?>";</pre>
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="ruby" role="tabpanel" aria-labelledby="ruby-tab">
                            <pre id="ruby-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
KeyAuth.new.Api(
    "<?= $appname; ?>",
    "<?= $ownerid; ?>",
    "<?= $secret; ?>",
    "<?= $version; ?>"
                        ...
                        <div class="p-4 rounded-lg bg-[#09090d]" id="perl" role="tabpanel" aria-labelledby="perl-tab">
                            <pre id="perl-creds" class="copy-target text-purple-400 bg-[#09090d] overflow-x-auto">
KeyAuth::Api(
    "<?= $appname; ?>",
    "<?= $ownerid; ?>",
    "<?= $secret; ?>",
                                ...
                                <td class="px-6 py-2 grid place-items-end pr-6">
                                    <form method="POST">
                                        <button value="<?= $appName ?>" name="selectApp" class="flex items-center">
                                            <span
                                                class="h-2.5 w-2.5 rounded-full bg-<?= $appSelected == 1 ? 'purple' : 'red'; ?>-500"></span>
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-[#0f0f17] rounded-lg border border-purple-700 shadow">
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <hr class="h-px mb-4 mt-4 bg-purple-700 border-0">
                        <form class="space-y-6" method="POST">
                            <div>
                                <div class="relative">
                                    <input type="text" id="appname" name="appname"
                                        class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border-1 border-purple-700 appearance-none focus:ring-0 peer"
                                        placeholder=" " autocomplete="on" required="">
                                    <label for="appname"
                                        class="absolute text-sm text-purple-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Application
                                        Name</label>
                                </div>
                            </div>
                            <button type="submit" name="create_app"
                                class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create
                                App</button>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" method="POST">
                            <div class="relative mb-4">
                                <input type="text" id="appname" name="appname"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border-1 border-purple-700 appearance-none focus:ring-0 peer focus:border-purple-700"
                                    placeholder=" " autocomplete="on" required="">
                                <label for="appname"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#0f0f17] border border-yellow-700  rounded-lg shadow">
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-purple-200">Are you sure
                            you want
                            to
                        ...
                        <form method="POST">
                            ...
                            <button data-modal-hide="pause-app-modal" type="button"
                                class="inline-flex text-white bg-purple-700 hover:opacity-60 focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 transition duration-200">No,
                                cancel</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-[#0f0f17] border border-red-700 rounded-lg shadow">
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-purple-200">Please enter your application name to delete
                            it. App
                            Name is: "<?= $appname; ?>"</h3>
                        <form method="POST">
                            <div>
                                <div class="relative mb-4">
                                    <input type="text" id="confirmappname" name="confirmappname"
                                        class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border-1 border-purple-700 appearance-none focus:ring-0  peer focus:border-red-700"
                                        placeholder=" " autocomplete="on" required="">
