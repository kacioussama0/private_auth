        ...
        <div class="mb-4 p-4">
            ...
            <div class="p-4 flex flex-col">
                <div class="overflow-x-auto">
                                    ...
                                    <form class="space-y-6" method="POST">
                                        <div>
                                            ...
                                            <div class="relative mb-4  ">
                                                ...
                                                <label for="blacktype"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Blacklist
                                                    Type</label>
                                            </div>
                                            ...
                                            <div class="relative mb-4">
                                                ...
                                                <label for="blackdata"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">IP
                                                    / HWID</label>
                                            </div>

                                        </div>
                                        <button type="submit" name="addblack"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Blacklist</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" method="POST">
                                        ...
                                        <button type="submit" name="addwhite"
                                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Whitelist</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <p class="text-xs text-red-600">Dropdown actions in <b>RED</b> do not show a confirmation!<a class="text-purple-700"> Dropdown actions in <b>purple</b> will show a confirmation!</a></p>
