            ...
            <div class="relative bg-[#0f0f17] rounded-lg border border-[#1d4ed8] shadow">
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" method="POST">
                        ...
                        <label for="baselink"
                            class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Base URL:</label>
                    ...
                    <label for="useragent"
                        class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">User-Agent:</label>
                </div>
                       
                        </div>
                        <button name="savewebhook"
                            class="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" value="' . $file . '">Save
                            Changes</button>
                        <button
                                        ...
                                        <div>
                                            <div class="relative mb-4">
                                                ...
                                                <label for="webhookname"
                                                    class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#0f0f17] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Webhook
                                                    Name (optional)</label>
                                            </div>
                                            <div class="relative mb-4">
                                                <input type="text" id="baselink" name="baselink"
                    ...
                    while ($row = mysqli_fetch_array($query->result)) {
                        ...
                        echo '<form method="POST">
                                ...
                                <ul x-show="open" x-on:click.away="open = false" class="bg-[#09090d] text-white rounded shadow-lg absolute py-2 mt-1" style="min-width:15rem">
                                        ...
                                        <li>
                                                <button name="editwebhook" class="block hover:opacity-60 whitespace-no-wrap py-2 px-4 hover:text-purple-700"
                                                value="' . $row["webid"] . '">
                                                Edit Webhook
                                                </button>
                                        </li>
