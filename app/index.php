    ...
    <div data-loader id="loader" class="bg-[#0f0f17]">
        <div class="text-center grid h-screen place-items-center">
            <div role="status" class="mt-96">
                <svg aria-hidden="true" class="inline w-8 h-8 mr-2 text-[#09090d] animate-spin fill-purple-600"
            ...
            <div class="block mt-32">
                <span class="text-xs font-semibold text-gray-500">
                    Loading taking a while? <a href="?page=manage-apps" class="text-purple-500 hover:underline">Please
