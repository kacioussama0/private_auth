...
<head>
    ...
    <meta name="title" content="SkylineAuth - Open Source Auth">

    <meta content="SkylineAuth" name="author" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="SkylineAuth, Cloud Authentication, Key Authentication,Authentication, API authentication,Security, Encryption authentication, Authenticated encryption, Cybersecurity, Developer, SaaS, Software Licensing, Licensing" />
    <meta property="og:image" content="https://skylinecheats.com/img/main.png" />
    <meta property="og:site_name" content="SkylineAuth | Secure your software from piracy." />
    <link rel="shortcut icon" type="image/jpg" href="https://skylinecheats.com/img/main.png">

    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="SkylineAuth">
    ...
    <meta itemprop="image" content="https://cdn.SkylineAuth.cc/front/assets/img/favicon.png">

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="product">
    <meta name="twitter:site" content="@SkylineAuth">
    <meta name="twitter:title" content="SkylineAuth - Open Source Auth">

    <meta name="twitter:creator" content="@SkylineAuth">
    <meta name="twitter:image" content="https://cdn.keyauth.cc/front/assets/img/favicon.png">

    <!-- Open Graph data -->
    <meta property="og:title" content="SkylineAuth - Open Source Auth" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="./" />

    <title>SkylineAuth - Login</title>

    <!-- Canonical SEO -->
    <link rel="canonical" href="https://skylinecheats.com" />
...
<body>
    ...
    <section class="absolute w-full" style="top: 50%;left: 50%;transform: translate(-50%,-50%)">
        <div class="relative z-10 flex items-center flex-wrap md:-m-8 ml-8 md:ml-24">
            <div class="w-full md:w-1/2 md:p-8">
                <div class="md:max-w-lg md:mx-auto md:pt-36">
                    <h2 class="mb-7 md:mb-12 text-3xl md:text-6xl font-bold font-heading tracking-px-n leading-tight text-center">
                        Welcome back to <span class="text-purple-600 inline-block">SkylineAuth</span>
                        👋
                    </h2>
                    ...
                    <form class="md:max-w-md md:ml-32 space-y-4 md:space-y-6" method="post" data-postform="1">
                        ...
                        ?>
                            ...
                            <div class="relative mb-4" data-twofactor="1">
                                <input type="text" id="SkylineAuthtwofactor" name="SkylineAuthtwofactor" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border-1 border-border-gray-300 appearance-none focus:ring-0  peer" placeholder=" " autocomplete="on">
                                <label for="SkylineAuthtwofactor" class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#09090d] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">2FA
                        ...
                        ?>
                            <div class="relative mb-4" data-username="1">
                                ...
                                <label for="username" class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#09090d] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Username</label>
                            </div>
                            ...
                            <div class="relative mb-4" data-password="1">
                                ...
                                <label for="password" class="absolute text-sm text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#09090d] px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Password</label>
                            </div>
<!---->
<!--                            <div class="relative mb-4" data-twofactor="1">-->
<!--                                <input type="text" id="SkylineAuthtwofactor" name="SkylineAuthtwofactor" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border-1 border-border-gray-300 appearance-none focus:ring-0  peer" placeholder=" " autocomplete="on">-->
...
<!--                            </div>-->
    ...
    if (isset($_POST['login'])) {
        ...
        * This code is also used to notify the SkylineAuth owner of account sharing, since that's against our ToS.
        */
            ...
            if($httpcode == 429) {
                ...
                if (!is_null($asNumSaved)) {
                    if ($asNum != $asNumSaved || $region != $regionSaved) {
                        // if user not using VPN and IP location changed, notify SkylineAuth owner of account sharing
                        ...
                        if($emailVerify) { // only require email verification if enabled.
                            if ($twofactor_optional) {
                                ...
                                $twofactor = misc\etc\sanitize($_POST['SkylineAuthtwofactor']);
                                if (empty($twofactor)) {
        ...
        if(strtolower($username) != "itsnetworking") {
            dashboard\primary\wh_log($logwebhook, "{$username} has logged into SkylineAuth with IP `{$ip}`", $webhookun);
        }
